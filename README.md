...
- <b> Analisi dei risultati: </b>
  ...
  <p style="font-size: 1.4em;"> 3. Metodo dei Minimi Quadrati (illuminazione reale): verificare la coerenza tra gli illuminamenti calcolati e quelli imposti (reale).</p>
